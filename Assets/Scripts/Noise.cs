...
namespace Assets.Scripts
{
    ...
    public class Noise
    {
        ...
        public static float Generate(float x, float y)
        {
            ...
            var x1 = x0 - i1 + g2; // Offsets for middle corner in (x,y) unskewed coordinates
            var y1 = y0 - j1 + g2;
            var x2 = x0 - 1.0f + 2.0f*g2; // Offsets for last corner in (x,y) unskewed coordinates
        ...
        public static float Generate(float x, float y, float z)
        {
            ...
            var x1 = x0 - i1 + g3; // Offsets for second corner in (x,y,z) coordinates
            var y1 = y0 - j1 + g3;
            var z1 = z0 - k1 + g3;
            var x2 = x0 - i2 + 2.0f*g3; // Offsets for third corner in (x,y,z) coordinates
            var y2 = y0 - j2 + 2.0f*g3;
            var z2 = z0 - k2 + 2.0f*g3;
            var x3 = x0 - 1.0f + 3.0f*g3; // Offsets for last corner in (x,y,z) coordinates
